...
public class ServiceTest {
		...
		private static final String mainPath = "research/";
		...
		public void startServer() throws Exception {
			...
			node.startService(new ServiceNameVersion(ResearchService.class.getName(), "1.0.0"), "a pass");
		...
		public void testGet() {
			try {
				...
				ClientResponse result = client.sendRequest("GET", mainPath + "dht_set/123", "");
